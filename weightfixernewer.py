...
with open('weightswithjuryo.csv', mode='r', newline='', encoding='utf-8') as infile:
...
with open('rikishi_full_summary_new_grouped.csv', mode='w', newline='', encoding='utf-8') as outfile:
    fieldnames = [
        'Rank','Opponent Rank',
        'Wins','Losses','Total Matches',
        'Win/Loss Ratio','WWOF', "WWOF%",'Win%'
    ]
    ...
    for rank in ranks:
        ...
        finalrows.append({
            ...
            'WWOF%':  round(summary_wwof/(summary_wwof+1), 4)          if summary_wwof  is not None else 'N/A',
